...
{
    /// <summary>
    /// Webová stránka se seznamem oddělení <see href="https://www.alza.cz/kariera"/>
    /// </summary>
    public class HomePage : Page
    {
        ...
        /// <summary>
        /// Constructor pro <see cref="HomePage"/>
        /// </summary>
        ...
        /// <summary>
        /// Vybere oddělení z tabulky/seznamu všech oddělení
        /// </summary>
        ...
        {
            Driver.GetLogger().Info("Filtruji nabídky oddělení '" + department + "'");
        ...
        /// <summary>
        /// Otevírá stránku se seznamem pozic vybraného oddělení
        /// </summary>
